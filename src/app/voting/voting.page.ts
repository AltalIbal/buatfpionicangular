...
export class VotingPage implements OnInit {
  ...
  async loadData() {
    await this.storage.create();
            ...
            this.http.get("http://localhost:8000/api/category", httpOptions)
              .subscribe((res: any) => {
                console.log(res);
              ...
              this.http.get("http://localhost:8000/api/is-voting", httpOptions)
              .subscribe((res: any) => {
                // console.log(res);
              ...
              this.http.get("http://localhost:8000/api/vote-check", httpOptions)
              .subscribe((res: any) => {
                // console.log(res);
...
async handleVote(id: any) {
  ...
  this.http.post(`http://localhost:8000/api/vote/${id}`,postData, httpOptions)
              .subscribe(res => {
                console.log(res);
...
async batalVote(id: any) {
  ...
  this.http.post(`http://localhost:8000/api/batal/${id}`,postData, httpOptions)
              .subscribe(res => {
                console.log(res);
                window.location.reload();
                // this.data = res.data.data.data;
